      ...
      <form onSubmit={handleSubmit} className="mb-6">
        <div className="relative">
          <input
            ...
            className="w-full px-4 py-3 pl-12 border border-[var(--color-border)] rounded-xl text-sm bg-[var(--color-bg-secondary)] text-[var(--color-text)] placeholder:text-[var(--color-text-muted)] focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]/30 focus:border-[var(--color-primary)] transition-all"
            autoFocus
          />
